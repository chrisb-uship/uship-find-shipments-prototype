// Inline Lucide-style icon set (stroke 2, 24x24) — reliable with React re-renders.
const ICONS = {
  ...
  "car": '<path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.5 2.8A4 4 0 0 0 2 13v3c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/>',
  ...
  "package-open": '<path d="M12 22v-9"/><path d="M15.17 2.21a1.67 1.67 0 0 1 1.63 0L21 4.57a1.93 1.93 0 0 1 0 3.36L8.82 14.79a1.655 1.655 0 0 1-1.64 0L3 12.43a1.93 1.93 0 0 1 0-3.36z"/><path d="M20 13v3.87a2.06 2.06 0 0 1-1.11 1.83l-6 3.08a1.93 1.93 0 0 1-1.78 0l-6-3.08A2.06 2.06 0 0 1 4 16.87V13"/><path d="M21 12.43a1.93 1.93 0 0 0 0-3.36L8.83 2.2a1.64 1.64 0 0 0-1.63 0L3 4.57a1.93 1.93 0 0 0 0 3.36z"/>',
...
function Icon({ name, size = 24, stroke = 2, className = "", style = {}, color }) {
...
// iOS status bar content for dark headers
function StatusBar({ time = "10:41" }) {
  return (
    <div className="statusbar">
      ...
      <span className="statusbar__right">
        ...
        <span style={{
          width: 24, height: 12, border: "1.6px solid #fff", borderRadius: 3,
          position: "relative", display: "inline-block"
        }}>
          <span style={{ position: "absolute", inset: "1.5px", right: "4px", background: "#fff", borderRadius: 1 }}></span>
          <span style={{ position: "absolute", right: "-3px", top: "3.5px", width: 2, height: 5, background: "#fff", borderRadius: 1 }}></span>
        </span>
      </span>
    </div>
  );
